...
public interface InterfaceDefaultValue {
    ...
    String API_YOUTUBE_MAIN_VIDEO = "https://youtube.googleapis.com/youtube/v3/videos?part=id&part=liveStreamingDetails&part=snippet&part=statistics&chart=mostPopular&maxResults=50&key=AIzaSyCznGLx-YBeHZ35Nv3Fz0trZCGCaVe7whw";
    ...
    String API_KEY = "AIzaSyCznGLx-YBeHZ35Nv3Fz0trZCGCaVe7whw";
